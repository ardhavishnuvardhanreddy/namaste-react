...
const Header = () =>{
 ...
 const RestaurantCard = (props) =>{
    ...
    return (
        ...
        <img className="res-logo" alt ="res-logo"src="https://cdn2.vectorstock.com/i/1000x1000/57/51/creative-burger-logo-design-symbol-vector-25895751.jpg"   + resData.data.cloudinaryImageId/>
        <h3>{resData.data.name}</h3>
        <h4>{resData.data.cuisins.join(",")}</h4>
